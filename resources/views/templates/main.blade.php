      ...
      <div class="container">      
        <div class="row space-100">
          <div class="col-lg-6 col-md-12 col-xs-12">
            <div class="contents">
              <h2 class="head-title">Slick Beauty<br>Flawless Perfection</h2>
        ...
        <div class="row">
          ...
          <div class="col-lg-6 col-md-12 pl-4">
            <div class="business-item-info">
              <h3>Slick: Aplikasi Kecantikan untuk Pengalaman Belanja Lebih Mudah</h3>
              <p>Dapatkan pengalaman belanja yang lebih mudah dan praktis dengan mengunduh aplikasi Slick di perangkat Android Anda. 
          ...
          <div class="col-lg-6 col-md-6 col-xs-12 p-0">
            ...
            <div class="feature-item featured-border1">
               ...
               <div class="feature-info float-left">
                 <h4>Shopping Chill</h4>
                 <p>Kenyamanan Pelanggan adalah Prioritas kami. 
                  <br>Pengiriman extra cepat <br>dan Cara pembelian yang mudah.</p>
               </div>
            </div>
            <!-- End Fetatures -->
          </div>
      ...
      <div class="container">
        ...
        <div class="row justify-content-center">
          ...
          <div class="col-lg-2 col-md-5 col-xs-12 mt-3">
            <div class="single-team">
              <div class="team-thumb">
                <img src="img/team/patresia.jpeg" class="img-fluid" alt="">
              </div>
          ...
          <div class="col-lg-2 col-md-5 col-xs-12 mt-3">
            <div class="single-team">
              ...
              <div class="team-details">
                ...
                <div class="team-inner text-center">
                  <h5 class="team-title">Yahya Ayyasy</h5>
